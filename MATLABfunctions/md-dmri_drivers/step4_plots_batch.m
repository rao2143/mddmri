...
datasets_paths{1+numel(datasets_paths)} = '/Users/daniel/Dropbox/NMRdata/GE/2018-11-22_Premier_corrected_waveforms/mdd';
% datasets_paths{1+numel(datasets_paths)} = '/Users/daniel/Dropbox/NMRdata/NIH_Philips/mdd';
% datasets_paths{1+numel(datasets_paths)} = '/Users/daniel/Dropbox/NMRdata/Mahajan/Mdd08/mdd';
...
% datasets_paths{1+numel(datasets_paths)} = '/Users/daniel/Dropbox/NMRdata/Caeyenberghs/FWF_DTC01_Caeyenberghs/mdd';
...
% bs_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/MR750_20190521/RWI_volunteer/mdd/MDD_intermediate/pdata/dtd/bootstrap'};
% out_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/MR750_20190521/RWI_volunteer/mdd/MDD_intermediate/pdata/pdf_maps'};
% in_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/Patients/mdd/MDD_intermediate_FS_Study30307/nii_xps'};
% bs_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/Patients/mdd/MDD_intermediate_FS_Study30307/dtd/bootstraps'};
% out_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/Patients/mdd/MDD_intermediate_FS_Study30307/dtd/maps'};
% bs_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/MR750_20190521/RWI_volunteer/mdd/MDD_intermediate/pdata/dtd/bootstrap'};
% out_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/MR750_20190521/RWI_volunteer/mdd/MDD_intermediate/pdata/dtd/maps'};
...
for ndata = 1:Ndata
    ...
    if ~all(cellfun('isempty',bs_dps))
        ...
        mplot_technicolor_nii(method, median_dps, fullfile(out_path,'nii'), clim, opt)
        ...
        mplot_technicolor_slicecollage(method, median_dps, fullfile(out_path,'slicecollage'), clim)
