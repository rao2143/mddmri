...
hp_fn = '/Users/daniel/Dropbox/NMRdata/United/summary_Wuhan_Brain_Glioma_20200324_DT.csv';
hp_fn = '/Users/daniel/Dropbox/NMRdata/United/histopathology_20200317_DT.csv';
hp_fn = '/Users/daniel/Dropbox/NMRdata/United/test.csv';

hp_table = readtable(hp_fn);
caseids = hp_table.caseid;
grades = hp_table.glioma_grade;
...
roiplots_path = fullfile(project_path,['roiplots_gliomas_' rois_name]);
