...
out_fn = '/Volumes/Matlab/analysis_data_from_FTP_RO/dcm_info_global.xlsx';
local_out_fn = '/Users/daniel/Dropbox/NMRdata/dcm_info_global.xlsx';

% log_fields = {'AcquisitionDateTime';'PatientName';'PatientID';'ScannerStudyID';'SeriesNumber';'SeriesDescription'};
log_fields = {'InstitutionName';'Manufacturer';'ManufacturerModelName';'ManufacturersModelName';'ProductId';'EquipmentUID';
    'MagneticFieldStrength';'TransmitCoilName';'ReceiveCoil';'ReceiveCoilName';'CoilString';'SoftwareVersion';'SoftwareVersions';...
    'AcquisitionDateTime';'StudyInstanceUID';'SeriesInstanceUID';'PatientName';'PatientID';'PatientSex';'PatientAge';'BodyPartExamined';...
    ...
    'PercentSampling';'PercentPhaseFieldOfView';'PartialFourier'
    };
    ...
    for ncase = 1:numel(case_ids)
        ...
        try
            ...
            for nnifti = 1:numel(NiftiNames)
                ...
                if ~isfield(h.(NiftiName),'AcquisitionDateTime'), break, end
