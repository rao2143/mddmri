...
%         dps_paths{1+numel(dps_paths)} = fullfile(datasets_path,expnam,'pdata',method);
%         out_paths{1+numel(out_paths)} = fullfile(datasets_path,expnam,'pdata','pdf_maps');
%     end
% end

in_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/Patients/mdd/MDD_intermediate_FS_Study30307/nii_xps'};
dps_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/Patients/mdd/MDD_intermediate_FS_Study30307/pdata/dtd_covariance'};
out_paths = {'/Users/daniel/Dropbox/NMRdata/MSKCC/Patients/mdd/MDD_intermediate_FS_Study30307/pdata/pdf_maps'};
...
for ndata = 1:Ndata
    ...
    dps_path = dps_paths{ndata};
    out_path = out_paths{ndata};

    median_dps = mdm_dps_load(fullfile(dps_path,'dps.mat'));
