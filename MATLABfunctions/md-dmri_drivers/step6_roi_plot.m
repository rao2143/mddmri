...
% data_names = data_names(contains(data_names,{'P0295156'}));
...
%     position = [left bottom+(Npanels-npanel)*dbottom width height];
    ...
    set([hh_legend_dtd; hh_MD_dtd; hh_shape_dtd; hh_vsize_dtd; hh_FA_dtd; hh_fraction3],'EdgeColor','b')
    set([hh_legend_covariance; hh_MD_covariance; hh_shape_covariance; hh_vsize_covariance; hh_FA_covariance; hh_fraction1],'EdgeColor','r')
    set([hh_legend_gamma; hh_MD_gamma; hh_shape_gamma; hh_vsize_gamma; hh_fraction2],'EdgeColor','g')
