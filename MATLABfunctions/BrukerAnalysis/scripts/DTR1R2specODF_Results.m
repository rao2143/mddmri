...
ExpNam = {'AOToct_Eq7'}; expno = 20:10:240; expno = 25;
...
%            'TickDir','out','TickLength',.03*[1 1])
    ...
    %%
        ...
        [dummy,indx] = sort(Signal,1,'descend');
        ...
        semilogy(1:bT.N,Signal(indx),'k-',1:bT.N,Scalc(indx),'k.',[1; bT.N],sqrt(chisq)*[1; 1],'k--')
        hold on
        semilogy(1:bT.N,Scalc_prolate(indx),'r.',1:bT.N,Scalc_oblate(indx),'g.',1:bT.N,Scalc_iso(indx),'b.')       
