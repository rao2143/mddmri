...
TR.min = 2000e-3; TR.max = 2000e-3; TR.N = 1;
...
[ga,gc,tm] = ndgrid(ga,gc,tm);
gb = G_mix.max*ones(G_filt.N,G_det.N,TM.N);
te = TE.max*ones(G_filt.N,G_det.N,TM.N);
tr = TR.max*ones(G_filt.N,G_det.N,TM.N);
